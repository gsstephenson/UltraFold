...
Correctness + performance hotfixes, plus an optional RNAstructure engine track. **v1.0.0 remains
the frozen citable reference** (git tag `v1.0.0`); this release is for new work only.
